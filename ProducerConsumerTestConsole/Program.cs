...
namespace ProducerConsumerTestConsole
{
    ...
    {
        private Cell _cell;         // Field to hold cell object to be used
        private int _quantity;      // Field for how many items to produce in cell

        public CellProd(Cell cell, int quantity)
        {
    ...
    public class CellCons
    {
        ...
        public CellCons(Cell cell, int quantity)
        {
            _cell = cell;          // Pass in what cell object to be used
            _quantity = quantity;  // Pass in how many items to consume from cell
        }
        ...
        public void ThreadRun()
        {
            ...
            for (int i = 1; i <= _quantity; i++)
            {
                ...
                valReturned = _cell.ReadFromCell();
            }
        }
    }
